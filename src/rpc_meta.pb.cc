...
static void InitDefaultsscc_info_rpc_header_rpc_5fmeta_2eproto() {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_rpc_header_rpc_5fmeta_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_rpc_header_rpc_5fmeta_2eproto}, {}};
...
const char descriptor_table_protodef_rpc_5fmeta_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\016rpc_meta.proto\"7\n\nrpc_header\022\024\n\014servic"
  "e_name\030\001 \001(\t\022\023\n\013method_name\030\002 \001(\tb\006proto"
  "3"
  ;
...
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_rpc_5fmeta_2eproto_sccs[1] = {
  &scc_info_rpc_header_rpc_5fmeta_2eproto.base,
};
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_rpc_5fmeta_2eproto = {
  &descriptor_table_rpc_5fmeta_2eproto_initialized, descriptor_table_protodef_rpc_5fmeta_2eproto, "rpc_meta.proto", 81,
...
void rpc_header::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_rpc_header_rpc_5fmeta_2eproto.base);
  service_name_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  method_name_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}

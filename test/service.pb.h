...
inline ::PROTOBUF_NAMESPACE_ID::int32 RegRequest::_internal_sex() const {
  return sex_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 RegRequest::sex() const {
  // @@protoc_insertion_point(field_get:RegRequest.sex)
  return _internal_sex();
}
inline void RegRequest::_internal_set_sex(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  sex_ = value;
}
inline void RegRequest::set_sex(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_sex(value);
  // @@protoc_insertion_point(field_set:RegRequest.sex)
}
